...
const ResumeSetting = ({userInfo}) => {
    ...
    formDataCover.append('imageAddress', userInfo?.imageAddress)
    formDataCover.append('ResumeCover', cover)
    formDataCover.append('PhoneNumber', userInfo?.PhoneNumber)
    formDataCover.append('bookmarkId', userInfo?.bookmarkId)
    formDataCover.append('bookmarks', userInfo?.bookmarks)
    formDataCover.append('Birthday', userInfo?.Birthday)
    formDataCover.append('degree', userInfo?.degree)
    formDataCover.append('file', userInfo?.file)
