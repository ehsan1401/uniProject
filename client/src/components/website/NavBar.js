        ...
        <ul className="flex h-full text-xl font-bold pt-1 relative">
            ...
            { !token &&
              <ul className="flex absolute left-4 top-2 mb-3 h-10 gap-2">
                <li className="flex px-5 bg-red-500 hover:bg-red-700 rounded-sm items-center duration-300 transition-all"><Link to="/Login">ورود</Link></li>
                <span className="flex items-center text-4xl cursor-default">/</span>
                <li className="flex px-5 border-2 border-solid border-emerald-400 text-emerald-400 hover:bg-neutral-500 rounded-sm items-center transition-all duration-300"><Link to="/Register">ثبت نام</Link></li>
              </ul>
            }
            { token &&
              <ul className="flex absolute left-4 top-2 mb-3 h-10 gap-2">
                <li className="flex px-5 border-2 border-solid border-emerald-400 text-emerald-400 hover:bg-neutral-500 rounded-sm items-center transition-all duration-300"><Link to="/Dashboard">داشبورد</Link></li>
              </ul>
            }
        </ul>
